...
class _KmrMaterialLocalizationsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  static const localeName = 'kmr';

  const _KmrMaterialLocalizationsDelegate();
  ...
  Future<MaterialLocalizations> load(Locale locale) async {
    return _loadedTranslations.putIfAbsent(locale, () {
      date_symbol_data_custom.initializeDateFormattingCustom(
        locale: localeName,
        symbols: IntlKmr.dateSymbols,
        patterns: IntlKmr.datePatterns,
      );
      numberFormatSymbols.putIfAbsent(localeName, () => IntlKmr.numberSymbols);

      return SynchronousFuture<MaterialLocalizations>(
        MaterialLocalizationKmr(
  ...
  @override
  bool shouldReload(_KmrMaterialLocalizationsDelegate old) => false;
}

// TODO TLAD translate from English
class MaterialLocalizationKmr extends GlobalMaterialLocalizations {
  MaterialLocalizationKmr({
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate = _KmrMaterialLocalizationsDelegate();
